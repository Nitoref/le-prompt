...
//     if (stats.ahead | stats.behind | stats.staged | stats.notStaged | stats.untracked | stats.conflicted )
//     {
...
//             strcpy(statsStr, " ");
//             if (stats.ahead)      strcat(statsStr, p->symbols->GitAhead);
//             if (stats.behind)     strcat(statsStr, p->symbols->GitBehind);
//             if (stats.staged)     strcat(statsStr, p->symbols->GitStaged);
//             if (stats.notStaged)  strcat(statsStr, p->symbols->GitNotStaged);
//             if (stats.untracked)  strcat(statsStr, p->symbols->GitUntracked);
//             if (stats.conflicted) strcat(statsStr, p->symbols->GitConflicted);
//             if (*(statsStr + 1) != '\0')
//             {
...
//         // else
//         // {
//         //     addRepoStat(segment, p->theme->GitConflicted, stats.conflicted, p->symbols->GitConflicted);
//         //     addRepoStat(segment, p->theme->GitUntracked,  stats.untracked,  p->symbols->GitUntracked);
//         //     addRepoStat(segment, p->theme->GitNotStaged,  stats.notStaged,  p->symbols->GitNotStaged);
//         //     addRepoStat(segment, p->theme->GitStaged,     stats.staged,     p->symbols->GitStaged);
//         //     addRepoStat(segment, p->theme->GitBehind,     stats.behind,     p->symbols->GitBehind);
//         //     addRepoStat(segment, p->theme->GitAhead,      stats.ahead,      p->symbols->GitAhead);
//         // }
//     }
//     // return segment -> head;
